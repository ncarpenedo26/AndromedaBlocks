...
// TODO (Nick) Update this
const nanoArduino: MicroController = {
  analonPins: ["A7", "A6", "A5", "A4", "A3", "A2", "A1", "A0"],
  digitalPins: [
    "2",
    "3",
    "4",
  ...
  type: MicroControllerType.ARDUINO_NANO,
  breadboard,
  skipHoles: [
